...
//    private RecyclerView mUploadList;
    ...
    String CategoryName, ProductName, Description, Company, Price, OriPrice, Quantity, ProductKeyward, ProductMDate, ProductEDate, storeCurruntDate, storeCurruntTime;
    ...
    EditText productName, productDescription, productKeyeard, productPrice, OriProductPrice, productCatagory, productQuantity, productCompany,
    ...
    EditText OriAdultPri, OriChildPri;
    ...
    private String Chh, AdultT = "A", ChildT = "A", AdultTPri = "A", ChildTPri = "A", OriAdultTPri = "A", OriChildTPri = "A", CatChh;
    private int A = 0, C = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productEDate = findViewById(R.id.ProductEDate);
        productMDate = findViewById(R.id.ProductMDate);

        productPrice = findViewById(R.id.ProductPrice);
        OriProductPrice = findViewById(R.id.ProductPriceOri);
        ...
        Adult = findViewById(R.id.ProductSR1);
        Child = findViewById(R.id.ProductSR2);

        AdultPri = findViewById(R.id.AdultPri);
        ChildPri = findViewById(R.id.ChildPri);

        OriAdultPri = findViewById(R.id.AdultPriOri);
        OriChildPri = findViewById(R.id.ChildPriOri);

        SearchRetail = findViewById(R.id.search_view_search_user);
        ReRetailPro = findViewById(R.id.Search_Search_user);
        ...
        ReRetailLayout = new LinearLayoutManager(AdminAddPhoneActivity.this, LinearLayoutManager.HORIZONTAL, false);
        ReRetailPro.setLayoutManager(ReRetailLayout);

        SearchProRe = FirebaseDatabase.getInstance().getReference().child("ReProduct");
        ...
        SearchProRe.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    AdminAddPhoneActivity.RetailProAdapter adapter = new AdminAddPhoneActivity.RetailProAdapter(PList);
    ...
    private void SearchItNow(String newText) {
        ...
        AdminAddPhoneActivity.RetailProAdapter adapter = new AdminAddPhoneActivity.RetailProAdapter(DList);
        ReRetailPro.setAdapter(adapter);
    ...
    public class RetailProAdapter extends RecyclerView.Adapter<AdminAddPhoneActivity.RetailProAdapter.Viewholder> {
        ...
        @NonNull
        @Override
        public AdminAddPhoneActivity.RetailProAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.product_iterm_layout, parent, false);
            return new AdminAddPhoneActivity.RetailProAdapter.Viewholder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull AdminAddPhoneActivity.RetailProAdapter.Viewholder holder, int position) {
