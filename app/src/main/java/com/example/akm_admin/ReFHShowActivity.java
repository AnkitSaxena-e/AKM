...
public class ReFHShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_re_f_h_show);

        FiFhone = findViewById(R.id.FirstF_R);
        SeFhone = findViewById(R.id.SecondS_R);
        ThFhone = findViewById(R.id.ThirdT_R);
        FoFhone = findViewById(R.id.ForthF_R);
        FvFhone = findViewById(R.id.FiveF_R);
        SiFhone = findViewById(R.id.SixS_R);

        II = findViewById(R.id.InfiUP_R);
        IIU = findViewById(R.id.AddUp_R);

        AddItt = findViewById(R.id.AddFhoneF_R);

        Category_Name = findViewById(R.id.CategoryName_R);
        Category_Value = findViewById(R.id.CategoryValue_R);

        CategoryAdd = findViewById(R.id.AddCategory_R);
    ...
    private void AddCategory(String name, String value) {
        ...
        DatabaseReference ProductRef = FirebaseDatabase.getInstance().getReference().child("ReCategory");
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(Task<Void> task) {
                        if (task.isSuccessful()) {
                            Intent i = new Intent(ReFHShowActivity.this, AdminMainActivity.class);
                            startActivity(i);
                            Toast.makeText(ReFHShowActivity.this, "Added successfully.......", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(ReFHShowActivity.this, "Error....", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    ...
    private void UPPP(String TT) {
        ...
        DatabaseReference reffff = FirebaseDatabase.getInstance().getReference().child("ReFFhones");
        ...
        reffff.updateChildren(pp).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(ReFHShowActivity.this, "Done", Toast.LENGTH_SHORT).show();
    ...
    private void GoAdd(String fi, String se, String th, String fo, String fv, String si) {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("ReFFhones");
