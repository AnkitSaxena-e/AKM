...
import com.example.akm_admin.Adapter.RetUserAdapter;
...
public class SeeUserRetailFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_see_user_retail, container, false);

        ANumberEdit = root.findViewById(R.id.numberSearchAdmin_PPPP_Retail);
        ANameEdit = root.findViewById(R.id.nameSearchAdmin_PPPP_Retail);

        UserReee = root.findViewById(R.id.AdminUserData_PPPPpp_Retail);
    ...
    public void onStart() {
        ...
        try {
            ...
            UserDA = FirebaseDatabase.getInstance().getReference().child("ReUser");
                ...
                UserDA.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            RetUserAdapter adapter = new RetUserAdapter(getActivity(), PListAA);
    ...
    private void searchItNumber(String newTextNum) {
        ...
        RetUserAdapter adapter = new RetUserAdapter(getActivity(), NewlistNum);
        UserReee.setAdapter(adapter);
    }
    ...
    private void searchItName(String newTextNa) {
        ...
        RetUserAdapter adapter = new RetUserAdapter(getActivity(), NewlistName);
        UserReee.setAdapter(adapter);
    }
