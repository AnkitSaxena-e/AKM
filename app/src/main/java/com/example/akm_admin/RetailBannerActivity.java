...
public class RetailBannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retail_banner);
        ...
        try {
            ...
            LoadingBar = new Dialog(RetailBannerActivity.this);
            ...
            AddImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(ActivityCompat.checkSelfPermission(RetailBannerActivity.this,
                            Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){

                        ActivityCompat.requestPermissions(RetailBannerActivity.this,
            ...
            Edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent p = new Intent(RetailBannerActivity.this, EditBannerActivity.class);
                    p.putExtra("Ad", "ReAds");
                    startActivity(p);
            ...
            Toast.makeText(RetailBannerActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
        }
    ...
    private void AddBanner() {
        ...
        DatabaseReference Arefkk = FirebaseDatabase.getInstance().getReference().child("ReAds");
    ...
    private void Flip() {
        ...
        mPager.setAdapter(new SliderLayoutAdapter(RetailBannerActivity.this,urls));
    ...
    private void uploadImage() {
        ...
        try {
            ...
            DatabaseReference refkk = FirebaseDatabase.getInstance().getReference().child("ReAds");
            ...
            refkk.updateChildren(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Toast.makeText(RetailBannerActivity.this, "Done", Toast.LENGTH_SHORT).show();
                }
            });
            LoadingBar.dismiss();
            Toast.makeText(RetailBannerActivity.this, "Image uploaded Successfully", Toast.LENGTH_LONG).show();
        ...
        if(requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK){
            ...
            if(data.getClipData() != null){
                ...
                if(clipData != null) {
                    for (int i = 0; i < clipData.getItemCount(); i++) {
                        ...
                        try {
                            ...
                            Toast.makeText(RetailBannerActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                ...
                for (Bitmap bm : bitmaps) {
                    Toast.makeText(RetailBannerActivity.this, Integer.toString(o), Toast.LENGTH_SHORT).show();
                    o++;
                            ...
                            fileToUpload.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    try{
                                        ...
                                        Toast.makeText(RetailBannerActivity.this, "for" + finalI, Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(RetailBannerActivity.this, "if" +  e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                ...
                Toast.makeText(RetailBannerActivity.this, "Selected Single File", Toast.LENGTH_SHORT).show();
            }
        }
    }
