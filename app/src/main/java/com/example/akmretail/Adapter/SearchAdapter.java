...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.Viewholder> {
    ...
    private String orderNo, Price, Pri;
    private Context context;

    public SearchAdapter(Context con, ArrayList<Product> categoryModals, String s, String vari) {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        try {
            ...
            String P = Modals.get(position).getPrice();
            String PN = Modals.get(position).getNo1Price();
            String PV = Modals.get(position).getAdultPrice();
            ...
            if(Pri.equals("Noooooo")){
                holder.BtatProductPrice.setText("₹" + "---");
            } else{
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                Paper.book().write(Prevalant.CheckH, CheckIt);
