...
import com.example.akmretail.Adapter.FiRecyAdapter;
import com.example.akmretail.Adapter.SliderLayoutAdapter;
...
public class HomeFragment extends Fragment {
    ...
    private String NName, IImage, type, Check, Vari;
    ...
    private RelativeLayout ScannerClick;
    private TextView PhoneA, PhoneB, PhoneC, PhoneD, PhoneE, PhoneF, UI, KYC_Text;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        ScannerClick = root.findViewById(R.id.pppp);
        ...
        KYC_Text = root.findViewById(R.id.kycText);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists()){
                    ...
                    if(Vari.equals("Noooooo")){
                        KYC_Text.setText("Complete Your KYC to Order Your Goods \n START KYC");
                    }

                    ScannerClick.setOnClickListener(v -> {
                        if(Vari.equals("Noooooo")){
                            Intent pp = new Intent(getActivity(), KYCActivity.class);
                            startActivity(pp);
                        } else {
                            Intent p = new Intent(getActivity(), ScanDocActivity.class);
                            startActivity(p);
                        }
                    });
            ...
            ProductRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        FiRecyAdapter adapter = new FiRecyAdapter(getActivity(), QList, type, Vari);
