...
import com.example.akmretail.EditAddressActivity;
...
//        window.setStatusBarColor(android.graphics.Color.parseColor("#093145"));
    ...
    public void onStar() {
        ...
        UserAddressref = FirebaseDatabase.getInstance().getReference().child("ReUAddressI").child(Paper.book().read(Prevalant.UserIdA));
...
//            }
    ...
    private void AddAddre() {
        ...
        DatabaseReference Userref = FirebaseDatabase.getInstance().getReference().child("ReUAddressI").child(Paper.book().read(Prevalant.UserIdA));
