...
public class MainActivity extends AppCompatActivity {
    ...
    private String parantName = "ReUser";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Let_Go = findViewById(R.id.login);
        ...
        Let_Go.setOnClickListener(v -> {

            String No = Get_Number.getText().toString();

            if (TextUtils.isEmpty(No)) {

                Get_Number.setError("Please Enter");
    ...
    private void CheckServ(String no) {

        DatabaseReference gg = FirebaseDatabase.getInstance().getReference().child(parantName).child(no);
        ...
        gg.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    String L = snapshot.child("Passward").getValue().toString();

                    String h = snapshot.child("Name").getValue().toString();

                    Intent l = new Intent(MainActivity.this, OTPJoinActivity.class);
                    l.putExtra("NNOO", no);
                    l.putExtra("Pass", L);
                    l.putExtra("Name", h);
                    startActivity(l);
                ...
                Intent l = new Intent(MainActivity.this, JoinActivity.class);
                LoadingBar.dismiss();
                l.putExtra("NNOO", no);
                startActivity(l);
            ...
            RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.child(parantName).child(Number).exists()) {
                        ...
                        String PPUU = dataSnapshot.child(parantName).child(Number).child("Passward").getValue().toString();
                            ...
                            if (userdata.getPassward().equals(passward)) {
                                ...
                                try {
                                    ...
                                    if (userdata.getSuspend().equals("A")) {
                                        ...
                                        Paper.book().write(Prevalant.userPasswardKey, PPUU);
