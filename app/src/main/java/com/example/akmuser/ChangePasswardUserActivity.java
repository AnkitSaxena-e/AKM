...
public class ChangePasswardUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            confermPasswardChange.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    private void ChangePass(String newPass) {
        ...
        try {
            ...
            PasswardRef.updateChildren(PassUpdate).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
