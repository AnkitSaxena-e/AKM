...
import com.example.akmuser.Adapter.ProductImageSlider;
import com.example.akmuser.ConfermOrderActivity;
import com.example.akmuser.HomeActivity;
import com.example.akmuser.Modal.Cart;
...
public class ProductDataFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        try {
            ...
            Num2 = root.findViewById(R.id.NumNum6);
            Num3 = root.findViewById(R.id.NumNum2);
            Num4 = root.findViewById(R.id.NumNum7);
            Num5 = root.findViewById(R.id.NumNum3);
            Num6 = root.findViewById(R.id.NumNum8);
            Num7 = root.findViewById(R.id.NumNum4);
            Num8 = root.findViewById(R.id.NumNum9);
            Num9 = root.findViewById(R.id.NumNum5);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        ProductID = addS(i, ProductID, snapshot.getValue().toString());
                    }
    ...
    private void updateRating(String productId, String r1, String r2, String r3, String r4, String r5) {
        ...
        URating.updateChildren(updateR).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    try {
                        ...
                        String gggggg = dataSnapshot.child("ProductName").getValue().toString();
                        String ggggll = dataSnapshot.child("Description").getValue().toString();

                        String ggggll_N = dataSnapshot.child("TName").getValue().toString();
                        String ggggll_D = dataSnapshot.child("TDetail").getValue().toString();
                        String ggggll_B = dataSnapshot.child("TBrand").getValue().toString();

                        productName.setText(gggggg);
                        productDescription.setText(ggggll);

                        if (dataSnapshot.child("Quantity").getValue().toString().equals("0")) {
                        ...
                        Image5 = dataSnapshot.child("Image5").getValue().toString();

                        String S1 = dataSnapshot.child("S1").getValue().toString();
                        String S2 = dataSnapshot.child("S2").getValue().toString();
                        String S3 = dataSnapshot.child("S3").getValue().toString();
                        String S4 = dataSnapshot.child("S4").getValue().toString();
                        String S5 = dataSnapshot.child("S5").getValue().toString();
                        ...
                        T2Pri = dataSnapshot.child("No2Price").getValue().toString();
                        T3Pri = dataSnapshot.child("No3Price").getValue().toString();
                        T4Pri = dataSnapshot.child("No4Price").getValue().toString();
                        T5Pri = dataSnapshot.child("No5Price").getValue().toString();
                        T6Pri = dataSnapshot.child("No6Price").getValue().toString();
                        T7Pri = dataSnapshot.child("No7Price").getValue().toString();
                        T8Pri = dataSnapshot.child("No8Price").getValue().toString();
                        T9Pri = dataSnapshot.child("No9Price").getValue().toString();
                        T10Pri = dataSnapshot.child("No10Price").getValue().toString();

                        String Ad = dataSnapshot.child("Adult").getValue().toString();
                        String Ch = dataSnapshot.child("Child").getValue().toString();

                        ChPri = dataSnapshot.child("ChildPrice").getValue().toString();
                        ...
                        T1Pri = dataSnapshot.child("No1Price").getValue().toString();
                        AdPri = dataSnapshot.child("AdultPrice").getValue().toString();
                        Priceee = dataSnapshot.child("Price").getValue().toString();
                        ...
                        if(Ad.equals("A") && Ch.equals("A")){
                            Re_AC.setVisibility(View.INVISIBLE);
                        }
                        ...
                        Col1 = dataSnapshot.child("Company").getValue().toString();
                        ...
                        Total_Star = String.valueOf(ne);

                        SetDesiValue.setText(Total_Star);
                        SetTotalRating.setText(String.valueOf(Lower) + " rating");
                        ...
                        BuyPP.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                    ...
                                    if (dataSnapshot.child("Quantity").getValue().toString().equals("0")) {
                                        ...
                                        if(SV.equals("AA") && SN.equals("AA") && C.equals("A") && A.equals("A") && N.equals("A")){
                                            ...
                                            AddProB(gggggg, SNum, SVariant, Col1, FiPrice, PQuantity.getNumber().toString(), Image1);
                        ...
                        CartPP.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                ...
                                if (dataSnapshot.child("Quantity").getValue().toString().equals("0")) {
                                    ...
                                    if(SVariant.equals("AA") && SNum.equals("AA") && Ch.equals("A") && Ad.equals("A") && N1.equals("A")){
                                        ...
                                        AddProC(gggggg, SNum, SVariant, Col1, FiPrice, PQuantity.getNumber().toString(), Image1);
                        ...
                        AdultTTTT.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                        ...
                        ChildTTTT.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
    ...
    private void AddProC(String name, String sNum, String sVariant, String company, String pricee, String s, String image1){
        ...
        reftg.child(ProductId).updateChildren(PPRR).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
