...
public class UserCostomerSupportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Submittttt.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void Add(String text) {
        ...
        ref.child(Time).updateChildren(su).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(UserCostomerSupportActivity.this, "Thanks for Your Feedback", Toast.LENGTH_SHORT).show();
            }
        });
    }
}